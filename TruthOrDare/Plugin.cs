...
//truthordare clear - clear the table"
    ...
    private List<string> GenerateTruths()
    {
        ...
        What's the cringiest thing you've said while trying to flirt?
        """.Split("\n").ToList();
    }
    ...
    private List<string> GenerateDares()
    {
        ...
        Have someone in the room dress you for five rounds.  If you're submissive, beg them eloquently.
        Have someone in the room gag and lock you for five rounds.  Beg them if you're submissive, or promise them a punishment if not.
        ...
        Ask someone to blindfold and lock it in for five rounds.  Or demand it of someone, if feeling dominant.
        """.Split("\n").ToList();
    }
    ...
    public void DummyRolls()
    {
        ...
        {
            // No longer need to put the special character  here. The unique one SE uses gets eaten,
    ...
    public void Start()
    {
        ...
        string channel = "/yell";   // TODO: configuration and maybe dropdown for the channel
        //string channel = "/echo"; 
